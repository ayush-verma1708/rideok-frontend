...
const RideInfo = () => {
  ...
  const [showFareModal, setShowFareModal] = useState(false); // State to manage modal visibility
        ...
        <Card.Body>
          <Row className='mb-4'>
            <Col md={6} className='text-center'>
              ...
              <Badge pill bg='info' className='mb-3'>
                {isDriver ? 'Car Captain' : 'Passenger'}
              </Badge>
              {isDriver ? (
            ...
            <Col md={6}>
              <h3 className='text-center mb-3'>Ride Route</h3>
              <RideMapView
          ...
          {currentUser && !isDriver && (
            <div className='text-center mt-4'>
              {/* Add any extra actions for passengers */}
            </div>
          )}
        </Card.Body>
      </Card>

      {/* Suggested Fare Modal */}
      <Modal show={showFareModal} onHide={handleCloseFareModal}>
        <Modal.Header closeButton>
          <Modal.Title>Suggested Fare</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Row>
            <Card className='shadow-sm rounded'>
              <Card.Body>
                ...
                <ul>
                  ...
                  <li>Driver Share: ₹{driverShare}</li>
                  <li>Passenger Fare: ₹{passengerFare}</li>
                </ul>
              </Card.Body>
            </Card>
          </Row>
        ...
        <Modal.Footer>
          <Button variant='secondary' onClick={handleCloseFareModal}>
            Close
          </Button>
        </Modal.Footer>
      </Modal>
...
//           <Row className='mb-4'>
//             <Col md={6} className='text-center'>
//               <h2 className='mb-3'>Ride Details</h2>
//               <h5>
//                 <strong>{ride.driver.name}</strong>
//               </h5>
//               <p className='text-muted'>
...
//               {/* <Button
//                 variant='primary'
//                 onClick={() => navigate(`/contact-driver/${ride.driver._id}`)}
//               >
//                 Contact Driver
//               </Button> */}
//             </div>
